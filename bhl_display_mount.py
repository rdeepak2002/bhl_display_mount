...
plate_length = 50.0  # Length of each side of the L
...
hole_offset = 15.0  # Distance from edge to hole center
...
base_plate = (
    ...
    .move(plate_length/2 - hole_offset, 0)
...
angled_plate = angled_plate.translate((plate_length/2, 0, 0))
